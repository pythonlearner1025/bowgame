/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 98d9dfcc40f05e8bd03f6f8bb8c56f4f)
// Runtime types generated with workerd@1.20260908.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	BOW_ROOM: DurableObjectNamespace<import("./worker/index").BowRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "BowRoom";
	}
